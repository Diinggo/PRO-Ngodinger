...
@section('judul','Native Developer - Ngodinger | Tutorial dan Informasi Seputar Dunia Pemrograman')
@section('desc','Native adalah pemrograman yang dibuat oleh')
@section('keys','Native, Manual, Library')
@section('foto','')
		...
		<div class="row">
			<div class="col-md-12">
				<div class="page-header bd-1px">
					<h1 class="ha1">Semua Pemrograman Native</h1>
				</div>
			</div>
			<!-- Iklan -->
			...
			<div class="col-md-3 col-sm-4">
				<div class="panel panel-primary mbtm">
					<div class="panel-heading text-center">
						<h4 class="ha3-margin">
						<a href="{{url('native',$data->sluglink)}}" 
