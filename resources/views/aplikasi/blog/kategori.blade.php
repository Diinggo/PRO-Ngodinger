...
@section('judul')@if(!empty($kate)){{$kate->nama}}@else{{$slug}}@endif - Kategori Artikel | Ngodinger @endsection
			...
			<div class="row">
				<div class="col-md-12">
					<div class="page-header bd-1px">
						<h1>Kategori : - @if(!empty($kate)) {{$kate->nama}} @else {{$slug}} @endif | Artikel</h1>
					</div>
				</div>
			<!--  -->
				<div class="col-md-12">
			...
			<!--  -->
				...
				<div class="col-md-4 col-sm-4">
					<div class="box box-small">
						<div class="box-head">
							<a href="{{url('blog',$data->slug)}}@yield('utm')" 
							...
							<div class="box-cat">
								<a href="{{url('blog/category',$data->slugkat)}}" 
				...
				<div class="col-sm-6 col-md-11 col-md-offset-1">
					<div class="form-group">
						<a href="{{url('blog/category')}}" 
							title="Kategori Pada Blog" class="btn btn-primary btn-block">Pilih Kategori</a>
					</div>
				<!-- Iklan -->
					<div class="show-iklan">
						@yield('c300')
							...
							<div class="media">
								...
								<div class="media-body media-garis">
									<h4 class="media-judul">
										<a href="{{url('blog/category',$more->slugkat)}}" 
