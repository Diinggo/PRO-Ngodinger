...
@section('judul')@if(!empty($kate)){{$kate->nama}}@else{{$slug}}@endif - Kategori Tutorial | Ngodigner @endsection
			...
			<div class="row">
				<div class="col-md-12">
					<div class="page-header bd-1px">
						<h1>Kategori : - @if(!empty($kate)) {{$kate->nama}} @else {{$slug}} @endif | Tutorial</h1>
					</div>
				</div>
			<!--  -->
				<div class="col-md-12">
			...
			<div class="row sideblog">
				<div class="col-sm-6 col-md-11 col-md-offset-1">
					<div class="form-group">
						<a href="{{url('tutor/category')}}" 
							title="Kategori Pada Tutorial" class="btn btn-primary btn-block">Pilih Kategori</a>
					</div>
				<!-- IKlan -->
					<div class="show-iklan">
						@yield('c300')
							...
							<div class="media">
								...
								<div class="media-body media-garis">
									<h4 class="media-judul">
										<a href="{{url('tutor/category',$more->slugkat)}}" 
