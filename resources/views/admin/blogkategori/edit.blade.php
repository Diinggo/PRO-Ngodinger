	...
	<div class="row">
		<div class="col-md-12">
			<div class="page-header">
				<h1>Edit Kategori <label class="label label-info">Tutorial</label></h1>
			</div>
		</div>
	<form method="post" action="{{ action('blogkategoricontrol@update',$data->id)}}">
	{{csrf_field()}}
	{{method_field('PUT')}}
		<div class="col-md-4 col-md-push-8">
			<div class="form-group">
				<label>Home</label>
				<a href="{{ url('admin/tutorkategori') }}" class="btn btn-danger btn-block but">
