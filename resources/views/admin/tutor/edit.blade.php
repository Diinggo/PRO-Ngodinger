...
@section('konten')
<form method="post" action="{{ action('tutorcontrol@update',$data->id) }}">
{{ csrf_field() }}
{{ method_field('PUT') }}
		...
		<div class="row">
			<div class="col-md-12">
				<div class="page-header">
					<h1>Edit <label class="label label-info">Tutorial</label> - {{$data->judul}}</h1>
				</div>
			</div>
		<!--  -->
			<div class="col-md-12">
				...
				<button type="submit" name="published" class="btn btn-info pull-right"><i class="fa fa-cloud-upload fa-lg"></i>&nbsp; Update</button>
				<hr>
			</div>
		<!--  -->
			<div class="col-md-12">
			...
			<div class="col-md-4 col-md-push-8">
				...
				<div class="form-group">
					...
					<select id="select" name="kategoriid" class="form-control" required="required">
						...
						@foreach($dat1 as $dat1) @if($dat1->id == $data->tutorid)
