...
@section('konten')
<form method="post" action="{{ action('skillcontrol@update',$data->id) }}">
{{ csrf_field() }}
{{ method_field('PUT') }}
		...
		<div class="row">
			<div class="col-md-12">
				<div class="page-header">
					<h1>Edit <label class="label label-danger">Skill</label> - {{$data->judul}}</h1>
				</div>
			</div>
		<!--  -->
			<div class="col-md-12">
				<a href="{{url('admin/skill')}}" class="btn btn-danger">
					<i class="fa fa-arrow-left fa-lg"></i>  Kembali</a>

				<button type="submit" name="published" class="btn btn-info pull-right">
			...
			<div class="col-md-4 col-md-push-8">
				...
				<div class="form-group">
					...
					<select id="select" name="kategoriid" class="form-control" required="required">
						...
						@foreach($dat1 as $dat1) @if($dat1->id == $data->skillid)
				...
				<div class="form-group">
					...
					<textarea name="deskripsi" class="form-control" placeholder="Masukkan Deskripsi" required="required" maxlength="160" rows="5">{{$data->deskripsi}}</textarea>
				</div>
		...
		<!--  -->
			<div class="col-md-8 col-md-pull-4">
				<div class="form-group">
					...
					<label class="label label-danger">Pilih: youtube.com/watch={yang disini}</label>
					<input type="text" name="video" class="form-control" placeholder="Masukkan Link Video" required="required"
					autofocus="true" autocomplete="false" value="{{$data->video}}">
				</div>
