...
@section('konten')
<form method="post" action="{{ action('blogcontrol@store') }}" autocomplete="false">
{{csrf_field()}}
	<div class="container-fluid">
		<div class="row">
			<div class="col-md-12">
				<div class="page-header">
					<h1>Tambah <label class="label label-info">Artikel</label></h1>
				</div>
			</div>
		<!--  -->
			<div class="col-md-12">
			...
			<div class="col-md-4 col-md-push-8">
				...
				<div class="form-group">
					...
					<textarea name="deskripsi" class="form-control" placeholder="Masukkan Deskripsi" 
						required="required" maxlength="160" rows="5"></textarea>
				</div>

				<div class="form-group">
					<label>Keywords</label>
					<label class="label label-info">Digunakan Untuk SEO Keywords</label>
