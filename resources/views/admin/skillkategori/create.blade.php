...
@section('konten')
<form method="post" action="{{ action('skillkategoricontrol@store') }}">
{{ csrf_field() }}
	<div class="container-fluid">
		<div class="row">
			<div class="col-md-12">
				<div class="page-header">
					<h1>Tambah Kategori <label class="label label-info">Skill</label></h1>
				</div>
			</div>
		<!--  -->
			...
			<div class="col-md-8 col-md-pull-4">
				...
				<div class="form-group">
					<label>Nama</label>
                	<input type="text" name="nama" class="form-control" placeholder="Masukkan Nama Kategori Skill" required="required" value="{{ old('nama') }}">
            	</div>
